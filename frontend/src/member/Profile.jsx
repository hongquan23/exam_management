...
import { ArrowLeft, User, Mail, Lock, ShieldCheck, Camera, Save } from "lucide-react";
...
const Profile = ({ currentUser }) => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "radial-gradient(circle at 20% 30%, rgba(37, 99, 235, 0.15) 0%, transparent 40%), radial-gradient(circle at 80% 70%, rgba(79, 70, 229, 0.15) 0%, transparent 40%)",
      }}
    >
      {/* Background Image Layer (Optional) */}
      <div className="absolute inset-0 opacity-20 pointer-events-none bg-cover bg-center" 
           style={{ backgroundImage: "url('https://cdn.bhdw.net/im/landscape-minimalist-wallpaper-81021_w635.webp')" }}></div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 shadow-2xl">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-white/50 text-xs uppercase tracking-widest font-bold ml-1">Mật khẩu cũ</label>
                    <div className="relative">
                      <input
                        type="password"
                        value={newPassword}
                ...
                <button
                  ...
                  className="w-full md:w-fit bg-white/10 hover:bg-white/20 border border-white/10 text-white font-bold py-4 px-10 rounded-2xl transition-all active:scale-[0.98]"
                >
                  Cập nhật Mật khẩu
                </button>
              </div>
